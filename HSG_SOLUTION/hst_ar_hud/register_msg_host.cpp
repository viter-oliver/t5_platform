...
void register_msg_host(msg_utility::msg_host& mh){
    mh.register_batch_cmd_handle([](u8* pbuff,u32 len)->bool{
        ...
        if(num_in_range(*pcmd,Vehicle_frame_b0,Vehicle_frame_b7)){
            ...
            float Addition_Vehicle_A_PosX=pcan->Addition_Vehicle_A_PosX*6.25;
            float Addition_Vehicle_A_PosY=pcan->Addition_Vehicle_A_PosY*6.25-3200.f;

            auto vehicle_id=*pcmd-Vehicle_frame_b0;
            if(vehicle_id==0){
                float Addition_Vehicle_B_PosX=pcan->Addition_Vehicle_B_PosX*6.25;
                float Addition_Vehicle_B_PosY=pcan->Addition_Vehicle_B_PosY*6.25-3200.f;                hud::pcar0->set_transz(Addition_Vehicle_A_PosX);
    ...
    mh.register_msg_handle(Vehicle_frame_a1,[&](u8* pbuff,int len){
        ...
        St_Vehicle_frame_a1* pcan=(St_Vehicle_frame_a1*)pbuff+2;
        float Target_Vehicle_PosX=pcan->Target_Vehicle_PosX*6.25;
        float Target_Vehicle_PosY=pcan->Target_Vehicle_PosY*6.25-3193.75;//*100 transfer to cm
    ...
    mh.register_msg_handle(Vehicle_frame_a2,[&](u8* pbuff,int len){
        ...
        St_Vehicle_frame_a2* pcan=(St_Vehicle_frame_a2*)pbuff+2;
        float Target_Vehicle_Width=pcan->Target_Vehicle_Width*5.f;
    ...
    mh.register_msg_handle(Vehicle_frame_c,[&](u8* pbuff,int len){
        ...
        St_Vehicle_frame_c* pcan=(St_Vehicle_frame_c*)pbuff+2;
        return false;
    });
    mh.register_msg_handle(Pedestrian_frame_a,[&](u8* pbuff,int len){
        ...
        St_Pedestrian_frame_a* pcan=(St_Pedestrian_frame_a*)pbuff+2;
        return false;
    });
    mh.register_msg_handle(lane_frame_1_l,[&](u8* pbuff,int len){
        ...
        St_lane_frame_1_l* pcan=(St_lane_frame_1_l*)pbuff+2;
    ...
    mh.register_msg_handle(lane_frame_1_h,[&](u8* pbuff,int len){
        ...
        St_lane_frame_1_h* pcan=(St_lane_frame_1_h*)pbuff+2;
    ...
    mh.register_msg_handle(lane_frame_2_l,[&](u8* pbuff,int len){
        ...
        St_lane_frame_2_l* pcan=(St_lane_frame_2_l*)pbuff+2;
    ...
    mh.register_msg_handle(lane_frame_2_h,[&](u8* pbuff,int len){
        ...
        St_lane_frame_2_h* pcan=(St_lane_frame_2_h*)pbuff+2;
    ...
    mh.register_msg_handle(TSR_frame_A,[&](u8* pbuff,int len){
        ...
        St_TSR_frame_A* pcan=(St_TSR_frame_A*)pbuff+2;
        return false;
    });
    mh.register_msg_handle(AEB_WARNING,[&](u8* pbuff,int len){
        ...
        St_AEB_WARNING* pcan=(St_AEB_WARNING*)pbuff+2;
        return false;
    });
}