...
{
     ps_shader ft_obj_3d::_phud_sd =nullptr;
     ps_primrive_object ft_obj_3d::_ps_prm = nullptr;
     ...
     void ft_obj_3d::link()
     {
          ...
          if( !ft_obj_3d::_phud_sd )
          {
               ft_obj_3d::_phud_sd = make_shared<af_shader>( _sd_vs, _sd_fs );
               ft_obj_3d::_ps_prm = make_shared<primitive_object>();
               _ps_prm->set_ele_format( { 3, 2 } );
               _ps_prm->load_vertex_data( _vertices, sizeof( _vertices ) / sizeof( float ) );
          }
     }
